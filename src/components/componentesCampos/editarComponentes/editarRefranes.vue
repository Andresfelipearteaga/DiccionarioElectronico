<template>
  ...
  export default {
    ...
    methods: {
      obtenerrefranes() {
        axios
          .get('https://edutlasdeveloper.pythonanywhere.com/apie/showtabler')
          .then((response) => {
      ...
      eliminarRefran(id) {
        axios
          .delete(`https://edutlasdeveloper.pythonanywhere.com/apie/refranes/${id}`)
          .then((response) => {
      ...
      openModal(id) {
        axios
          .get(`https://edutlasdeveloper.pythonanywhere.com/apie/refranes/${id}/image`)
          .then((response) => {
