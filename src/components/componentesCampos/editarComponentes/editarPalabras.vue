<template>
  ...
  export default {
    ...
    methods: {
      obtenerPalabras() {
        axios
          .get('https://edutlasdeveloper.pythonanywhere.com/apie/showtable')
          .then((response) => {
      ...
      eliminarPalabra(id) {
        axios
          .delete(`https://edutlasdeveloper.pythonanywhere.com/apie/palabras/${id}`)
          .then((response) => {
      ...
      openModal(id) {
        axios
          .get(`https://edutlasdeveloper.pythonanywhere.com/apie/palabras/${id}/image`)
          .then((response) => {
