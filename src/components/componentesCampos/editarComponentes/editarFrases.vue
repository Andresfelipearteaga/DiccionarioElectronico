<template>
  ...
  export default {
    ...
    methods: {
        obtenerfrases() {
        axios
          .get('https://edutlasdeveloper.pythonanywhere.com/apie/showtablef')
          .then((response) => {
      ...
      eliminarFrase(id) {
        axios
          .delete(`https://edutlasdeveloper.pythonanywhere.com/apie/frases/${id}`)
          .then((response) => {
            console.log(response.data);
      ...
      openModal(id) {
        axios
          .get(`https://edutlasdeveloper.pythonanywhere.com/apie/frases/${id}/image`)
          .then((response) => {
