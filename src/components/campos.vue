    ...
    <div>
      <nav class="campo-nav">
        <ul>
          ...
          <li><router-link to="/Campos/ingresar-refranes" exact exact-active-class="active-link">Refranes</router-link></li>
          <li><router-link to="/Campos/ingresar-frases" exact exact-active-class="active-link">Frases proverbiales</router-link></li>
        </ul>
      </nav>
